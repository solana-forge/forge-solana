...
pub fn app<'a>(version: &'a str, default_args: &'a DefaultArgs) -> App<'a, 'a> {
    return App::new(crate_name!()).about(crate_description!())
        ...
        .arg(
            Arg::with_name("pbs_url")
                .long("pbs-url")
                .help("PBS url. Set to empty string to disable pbs connection.")
                .takes_value(true)
        )
        .arg(
            Arg::with_name("pbs_uuid")
                .long("pbs-uuid")
                .help("PBS UUID. Set to empty string to disable pbs connection.")
                .takes_value(true)
        )
        .arg(
