...
use {
    forge_protos::proto::packet::Packet as ProtoPacketForge,
...
pub fn proto_packet_to_packet_forge(p: ProtoPacketForge) -> Packet {
...
pub fn packet_to_proto_packet_forge(p: &Packet) -> Option<ProtoPacket> {
    Some(ProtoPacket {
        data: p.data(..)?.to_vec(),
        meta: Some(ProtoMeta {
